...
- 🎯 Entry points to execute your program using `python -m <testing>` or `$ testing` with basic CLI argument parsing.
...
Awesome testing created by D3fus
...
```bash
git clone https://github.com/D3fus/testing testing
cd testing
make install
```
...
```bash
testing create-db   # run once
testing populate-db  # run once (optional)
testing add-user -u admin -p 1234  # ads a user
testing run
```
